...
@Component
public class List extends AbstractAdminCommand
{
  @Autowired
  private JMXService jmxSrv;
  
  @CliCommand(value = "list deployed", help = "list deployed")
  public void execute()
  {
    String oname = MBeanHelper.createManagerMBeanName("HotDeploy");
    String names= jmxSrv.invokeOperation(oname, "getModuleNames").toString();
