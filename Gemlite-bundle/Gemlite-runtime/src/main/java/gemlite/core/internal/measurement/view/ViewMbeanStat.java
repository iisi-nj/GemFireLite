...
@GemliteMBean(name="RegionView")
@ManagedResource(description="View Stat")
public class ViewMbeanStat extends AbstractViewStat implements Serializable
{
	private static final long serialVersionUID = 987857218865383615L;

	@AggregateAttribute(AggregateType.SUM)
	@ManagedAttribute(description="View Entry Size")
