...
public class FileToGFTestProcessor extends ITestProcessor
{
	private String[] param;
	public FileToGFTestProcessor(String[] args)
	{
		param = args;
	}
	...
	public void process()
	{
	    ...
	    try
	    {
	      ...
	      HAMqReceiver receiver = MqReceiverBuilder.createFileClientForTesting();
