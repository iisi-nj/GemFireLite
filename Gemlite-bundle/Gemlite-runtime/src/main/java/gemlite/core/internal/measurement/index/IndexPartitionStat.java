...
@GemliteMBean(name="PartitionRegionIndex")
@ManagedResource(description="Partition Region Index Stat")
public class IndexPartitionStat extends AbstractIndexStat implements Serializable
{
	private static final long serialVersionUID = -3754154056652328608L;
