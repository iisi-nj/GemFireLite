...
public class DataStore implements IEventDispatcher
{
  ...
  public void waitForComplete()
  {
    while (true)
    {
      if (!mainContext.getBean(Cache.class).isClosed())
      {
        try
        {
          Thread.sleep(500L);
  ...
  //
  // Object af = Class.forName("com.gemstone.gemfire.cache.AttributesFactory").newInstance();
  ...
  // try
  // {
  // mgmRegion = cc.createVMRegion(MGM_REGION_NAME, af.create(), internalArgs);
  // }
