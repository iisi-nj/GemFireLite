...
public class DomainResolver implements PartitionResolver<Object, Object> 
{
	public void close()
	{
	...
	public Object getRoutingObject(EntryOperation<Object, Object> op) 
	{
		...
		if(key instanceof CustomerDBKey)
			return ((CustomerDBKey) key).getName();
		else if(key instanceof OrderKey)
			return ((OrderKey) key).getName();
		else if(key instanceof DetailKey)
			return ((DetailKey) key).getName();
